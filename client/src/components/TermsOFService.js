...
const TermsOFService = () => {
  return (
    <div className="container" id="terms_cond">
      ...
      <div className="def_sec">
        <h1 className="my-4">Definitions</h1>
        ...
        <ul>
          ...
          <li>
            ...
            "Our" in this Agreement) refers to LemonTree Media LLC, 509 West
            110th St, New York, NY 10025.
          </li>
          <li>
          ...
          <li>
            <b>Website</b> refers to LemonTree Media, accessible from{" "}
            <a href="https://www.lemontreemedia.io/">
              https://www.lemontreemedia.io
            </a>
          </li>
          <li>
      ...
      <div className="new_style">
        ...
        <h1 className="my-4">Governing Law</h1>
        <p>
        ...
        <h1 className="my-4">Disputes Resolution</h1>
        <p>
          If You have any concern or dispute about the Service, You agree to
          first try to resolve the dispute informally by contacting the Company.
        </p>
        <h1 className="my-4">For European Union (EU) Users</h1>
        <p>
          If You are a European Union consumer, you will benefit from any
          mandatory provisions of the law of the country in which you are
          resident in.
        </p>
        <h1 className="my-4">United States Legal Compliance</h1>
        <p>
        ...
        <h1 className="my-4">Severability and Waiver</h1>
        <h2 className="my-4">Severability</h2>
        <p>
        ...
        <h1 className="my-4">Changes to These Terms and Conditions</h1>
        <p>
        ...
        <ul style={{marginBottom:'5%'}}>
          <li style={{fontSize:'18px'}}>By email: info@lemontreemedia.io</li>
        </ul>
      </div>
    </div>
  );
