...
const PrivacyPolicy = () => {
  return (
    <div className="container" id="privacy">
      ...
      <div className="def_privacy">
        ...
        <ul>
          ...
          <li>
            ...
            <a href="https://www.lemontreemedia.io" className="link">
              {" "}
      ...
      <p>
        <b>Cookies can be "Persistent" or "Session" Cookies.</b> Persistent
      ...
      <ul style={{ marginBottom: "5%" }}>
        <li style={{ fontSize: "17px" }}>
          By email: michael@lemontreemedia.io
        </li>
      </ul>
    </div>
  );
